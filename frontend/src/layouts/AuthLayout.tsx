    ...
    <div className="min-h-screen w-full grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-slate-900 p-10 text-white overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          ...
          >
            <path
              d="M0 100 L0 50 Q50 0 100 50 L100 100 Z"
              fill="url(#gradient)"
            />
            <defs>
        ...
        <div className="relative z-10 flex items-center space-x-2">
          ...
          <span className="text-xl font-bold tracking-wide">
            Hongsa Power <span className="text-blue-400">RTMS</span>
          </span>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-slate-900/50 p-4 rounded-lg border border-slate-700">
                ...
                <div className="text-2xl font-bold text-white">
                  120{" "}
                  <span className="text-sm text-slate-500 font-normal">MW</span>
                </div>
        ...
        <div className="relative z-10">
          <blockquote className="space-y-2">
            <p className="text-lg font-medium leading-relaxed">
              "ระบบ Real-time Machine Status
              ช่วยให้เราวางแผนการผลิตไฟฟ้าได้อย่างแม่นยำ ลดความผิดพลาด
              และเพิ่มประสิทธิภาพสูงสุดให้กับโรงไฟฟ้าหงสา"
            </p>
