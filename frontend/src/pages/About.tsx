      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            ระบบบริหารจัดการสถานะเครื่องจักรและพยากรณ์กำลังการผลิต
            สำหรับโรงไฟฟ้าหงสา (Hongsa Power)
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
          ...
          <div className="p-8 md:p-12 border-b border-slate-100">
            ...
            <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-4">
              <p>
                โครงการพัฒนาระบบ{" "}
                <strong>Real Time Machine Status & Forecasting</strong>{" "}
                นี้จัดทำขึ้นเพื่อแก้ปัญหาความล่าช้าและความผิดพลาดในการบันทึกข้อมูลแบบ
                Manual เดิม โดยมีเป้าหมายหลักคือ:
              </p>
          ...
          <div className="p-8 md:p-12 bg-blue-600 text-white text-center">
            ...
            <p className="text-blue-100 mb-6">
              หากพบปัญหาในการใช้งาน หรือต้องการสอบถามข้อมูลเพิ่มเติม
              สามารถติดต่อทีม IT Support
            </p>
